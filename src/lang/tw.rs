...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連接至 HiDesk 網路..."),
        ("Enable Service", "啟用服務"),
        ("Start Service", "啟動服務"),
        ...
        ("Set Password", "設置密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC 會導致 HiDesk 在某些情況下無法正常以遠端電腦運作。若要避開 UAC，請點擊下方按鈕將 HiDesk 安裝到系統中。"),
        ("Click to upgrade", "點擊以升級"),
        ("Click to download", "點擊以下載"),
        ("Click to update", "點擊以更新"),
        ("Configure", "設定"),
        ("config_acc", "您需要授予 HiDesk ｢協助工具」 權限才能遠端存取電腦。"),
        ("config_screen", "您需要授予 HiDesk ｢畫面錄製」 權限才能遠端存取電腦。"),
        ("Installing ...", "正在安裝..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ...
        ("android_input_permission_tip2", "請在接下來的系統設定頁面中，找到並進入 ｢已安裝的服務｣ 頁面，並將 ｢HiDesk Input｣ 服務開啟"),
        ...
        ("Language", "語言"),
        ("Keep HiDesk background service", "保持HiDesk後台服務"),
        ("Ignore Battery Optimizations", "忽略電池優化"),
        ("android_open_battery_optimizations_tip", "如需關閉此功能，請在接下來的HiDesk應用設置頁面中，找到並進入 [電源] 頁面，取消勾選 [不受限制]"),
