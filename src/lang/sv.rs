...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till HiDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte HiDesk fungera ordentligt på klientsidan. För att undvika UAC, tryck på knappen nedan för att installera HiDesk på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge HiDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge HiDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [HiDesk Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep HiDesk background service", "Behåll HiDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa HiDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
