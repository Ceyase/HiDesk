...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do HiDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o HiDesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o HiDesk no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao HiDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao HiDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o HiDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [HiDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep HiDesk background service", "Manter o serviço do HiDesk executando em segundo plano"),
