...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі HiDesk..."),
        ...
        ("install_tip", "У деяких випадках через UAC HiDesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче, щоб встановити HiDesk у системі"),
        ...
        ("config_acc", "Щоб віддалено керувати своєю стільницею, ви повинні надати HiDesk права \"доступності\""),
        ("config_screen", "Для віддаленого доступу до стільниці ви повинні надати HiDesk права для \"запису екрану\""),
        ...
        ("android_input_permission_tip1", "Щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або торкання, вам необхідно дозволити HiDesk використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [HiDesk Input]."),
        ...
        ("Language", "Мова"),
        ("Keep HiDesk background service", "Зберегти фонову службу HiDesk"),
