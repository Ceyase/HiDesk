...
pub fn start_os_service() {
    ...
    /* // mouse/keyboard works in prelogin now with launchctl asuser.
       ...
       // one way is to start with `launchctl asuser <uid> open -n -a /Applications/HiDesk.app/ --args --cm`,
       // this way --cm is started with the user privilege, but we will have problem to start another HiDesk.app
