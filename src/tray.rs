...
fn get_default_app_indicator() -> Option<AppIndicator> {
    ...
    let mut appindicator = AppIndicator::new("HiDesk", icon_path.to_str().unwrap_or("rustdesk"));
    appindicator.set_label("HiDesk", "A remote control software.");
