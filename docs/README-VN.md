<p align="center">
  <img src="../res/logo-header.svg" alt="HiDesk - Phần mềm điểu khiển máy tính từ xa dành cho bạn"><br>
  ...
  <b>Chúng tôi cần sự gíup đỡ của bạn để dịch trang README này, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">HiDesk UI</a> và <a href="https://github.com/rustdesk/doc.rustdesk.com">tài liệu</a> sang ngôn ngữ bản địa của bạn</b>
</p>
...
Mọi người đều đuợc chào đón để đóng góp vào HiDesk. Để bắt đầu, hãy đọc [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).

[**HiDesk hoạt động như thế nào?**](https://github.com/rustdesk/rustdesk/wiki/How-does-HiDesk-work%3F)
...
HiDesk hiện không hỗ trợ Wayland. Hãy xem [đường linh ở đây](https://docs.fedoraproject.org/en-US/quick-docs/configuring-xorg-as-default-gnome-session/) cách để cài đặt Xorg làm session mặc định của GNOME.
...
Hãy đảm bảo là bạn đang chạy những lệnh này từ thu mục rễ của repo HiDesk, vì nếu không thì ứng dụng có thể sẽ không tìm đuợc những tệp tài nguyên cần thiết. Cũng như nhớ rằng những lệnh con của cargo như `install` hoặc `run` hiện chưa được hỗ trợ bởi phương pháp này vì chúng sẽ cài đặt hoặc chạy ứng dụng trong container thay vì trên máy tính của bạn.
