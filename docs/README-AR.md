<p align="center">
  ...
  <b>  لغتك الأم,  <a href="https://github.com/rustdesk/doc.rustdesk.com">Doc</a> و <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">HiDesk UI</a>, README نحن بحاجة إلى مساعدتك لترجمة هذا </b>
</p>
...
لمساعدتك على ذلك [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) يرحب بمساهمة الجميع. اطلع على  HiDesk.

[**؟ HiDesk كيفية يعمل**](https://github.com/rustdesk/rustdesk/wiki/How-does-HiDesk-work%3F)
...
افتراضية GNOME session  ك Xorg إتبع [هذه](https://docs.fedoraproject.org/en-US/quick-docs/configuring-xorg-as-default-gnome-session/) الخطوات لإعداد Wayland لا تدعم HiDesk
...
HiDesk يرجى التأكد من أنك تنفذ هذه الأوامر من جذر مستودع
